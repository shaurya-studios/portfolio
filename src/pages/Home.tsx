  ...
  return (
    <div className="w-full pb-32" ref={containerRef}>
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto overflow-hidden">
        <motion.div style={{ y, opacity }} className="relative z-10 mt-20 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-3/5">
            ...
            <motion.h1 
              ...
              className="text-display-lg text-gradient mb-8 leading-[1.1]"
            >
          ...
          >
            ...
            <div className="card-border p-8 rounded-2xl relative overflow-hidden backdrop-blur-xl bg-black/40 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-700">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--color-accent)] rounded-full blur-[80px] opacity-20" />
              <h3 className="text-xl font-bold mb-6 text-white">Core Stack</h3>
              <div className="flex flex-wrap gap-3">
                {['React', 'Next.js', 'TypeScript', 'Tailwind', 'Node.js', 'Vercel', 'PostgreSQL', 'Framer Motion'].map(tech => (
                  <span key={tech} className="px-4 py-2 rounded-full text-sm font-mono bg-white/5 border border-white/10 text-gray-300">
                    {tech}
                  </span>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 gap-12">
          ...
          >
            <div className="p-12 md:w-1/2 flex flex-col justify-center relative z-10">
              <div className="mb-8">
                <span className="text-[var(--color-accent)] font-mono text-sm tracking-widest uppercase mb-4 block">Creative Agency</span>
                <h3 className="text-4xl font-bold mb-4">Editify Studios</h3>
            ...
            <div className="md:w-1/2 h-[400px] md:h-auto bg-[#111] relative overflow-hidden border-l border-[var(--color-border)] flex items-center justify-center">
              ...
              <div className="text-white/20 font-bold text-4xl uppercase tracking-widest">Editify-Studios</div>
            </div>
          </motion.div>
          ...
          >
            <div className="p-12 md:w-1/2 flex flex-col justify-center relative z-10">
              <div className="mb-8">
                <span className="text-[var(--color-accent)] font-mono text-sm tracking-widest uppercase mb-4 block">Web Platform</span>
                <h3 className="text-4xl font-bold mb-4">Thumbpilot</h3>
                <p className="text-[var(--color-text-secondary)] leading-relaxed">
            ...
            <div className="md:w-1/2 h-[400px] md:h-auto bg-[#111] relative overflow-hidden border-r border-[var(--color-border)] flex items-center justify-center">
              ...
              <div className="text-white/20 font-bold text-4xl uppercase tracking-widest">Thumbpilot</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      {/* 4.5 PRICING */}
      <section id="pricing" className="py-32 px-6 md:px-12 max-w-7xl mx-auto border-t border-[var(--color-border)]">
        <h2 className="text-center text-display-md mb-6">Investment</h2>
        <p className="text-center text-xl text-[var(--color-text-secondary)] max-w-2xl mx-auto mb-16">
          Transparent pricing for world-class digital craftsmanship.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          
          {/* Tier 1 */}
          <div className="card-border rounded-2xl p-8 flex flex-col relative">
            <h3 className="text-xl font-bold text-[var(--color-text-secondary)] mb-4 uppercase tracking-widest">Starter</h3>
            <div className="mb-8">
            ...
            <MagneticButton href="mailto:shaurya.studios.dev@gmail.com" className="w-full text-center border border-[var(--color-border)] hover:bg-white/5">
              Select Plan
            </MagneticButton>
          </div>

          {/* Tier 2 */}
          <div className="card-border rounded-2xl p-8 flex flex-col relative border-[var(--color-accent)] shadow-[0_0_30px_rgba(94,106,210,0.15)]">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[var(--color-accent)] text-white text-xs font-bold uppercase tracking-widest py-1 px-4 rounded-full">
              Most Popular
            </div>
            <h3 className="text-xl font-bold text-[var(--color-text-secondary)] mb-4 uppercase tracking-widest">Professional</h3>
            <div className="mb-8">
            ...
            <MagneticButton href="mailto:shaurya.studios.dev@gmail.com" className="w-full text-center bg-[var(--color-accent)] text-white hover:bg-[var(--color-accent)]/80">
              Select Plan
            </MagneticButton>
          </div>
          ...
          {/* Tier 3 */}
          <div className="card-border rounded-2xl p-8 flex flex-col relative">
            <h3 className="text-xl font-bold text-[var(--color-text-secondary)] mb-4 uppercase tracking-widest">E-Commerce</h3>
            <div className="mb-8">
          ...
          {/* Tier 4 */}
          <div className="card-border rounded-2xl p-8 flex flex-col relative bg-gradient-to-b from-[#111] to-[#0a0a0a]">
            <h3 className="text-xl font-bold text-[var(--color-text-secondary)] mb-4 uppercase tracking-widest">Custom</h3>
            <div className="mb-8">
              <span className="text-5xl font-black tracking-tight">Enterprise</span>
            </div>
            <ul className="space-y-4 mb-8 flex-grow">
      ...
      {/* 5. TESTIMONIALS */}
      <section className="py-32 px-6 md:px-12 max-w-4xl mx-auto border-t border-[var(--color-border)]">
        <h2 className="text-center text-3xl font-bold mb-16">Client Success</h2>
        <div className="grid grid-cols-1 gap-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="card-border p-8 md:p-12 rounded-xl relative overflow-hidden group">
            ...
            <p className="text-lg md:text-2xl leading-relaxed mb-10 italic font-medium">"Shaurya is a 10/10 website builder, highly recommended. He offers the best prices in the market."</p>
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-black border border-[var(--color-border)] overflow-hidden flex items-center justify-center p-2">
                <img src="/editify-logo.png" alt="Editify Studios" className="w-full h-full object-contain" />
              </div>
              <div>
                <h4 className="font-bold text-lg">Editify Studios</h4>
